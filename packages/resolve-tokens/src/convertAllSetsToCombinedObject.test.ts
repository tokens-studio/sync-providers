...
describe('convertAllSetsToArray', () => {
  ...
  it('should generate merged tokens for each theme option', async () => {
    ...
    const expectedTokenSetArrays = {
      'mode/light': [{name: 'color.background.primary', value: '#FFFFFF', type: 'color'}, {name: 'color.background.secondary', value: '#F0F0F0', type: 'color'}],
      'mode/dark': [{name: 'color.background.primary', value: '#000000', type: 'color'}, {name: 'color.background.secondary', value: '#1A1A1A', type: 'color'}],
      'primitives': [{name: 'color.gray.100', value: '#000000', type: 'color'}, {name: 'color.gray.900', value: '#FFFFFF', type: 'color'}],
      'components': [{name: 'button.background', value: '#000000', type: 'color'}, {name: 'button.foreground', value: '#FFFFFF', type: 'color'}],
    }
